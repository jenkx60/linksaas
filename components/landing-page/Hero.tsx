                ...
                <>
                    <div className='flex flex-col items-center text-center gap-6 max-w-full mx-auto'>
                        ...
                        <div className='mb-6 flex gap-6 w-full max-w-[60%] mx-auto'>
                            <button className='w-full bg-[#143DB8] shadow shadow-[#143DB8] rounded-[24px] py-2.5 text-white font-bold text-[14px] leading-6 tracking-[0px] cursor-pointer'>
                                Create Free Account
                            </button>

                            <button className='w-full flex items-center justify-center gap-2 bg-white border border-[#E2E8F0] shadow shadow-[#0000000D] rounded-[24px] py-2.5 pl-3 pr-3.5 text-[#334155] font-bold text-[14px] leading-6 tracking-[0px] cursor-pointer'>
